...
## Correspondance guide ↔ diagrammes

| Ce guide                     | Diagramme                          |
| ---------------------------- | ---------------------------------- |
| Cycle long — 7 phases        | `SDLC.png`                         |
| Boucle journalière           | `Day-cycle-LLM.png`                |
| Ouverture (repo, outils)     | `Architecture-outils.png`          |
| Règles transverses           | 4e diagramme (à construire)        |
